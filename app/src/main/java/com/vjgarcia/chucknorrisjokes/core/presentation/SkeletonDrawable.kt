...
class SkeletonDrawable(
    ...
    private companion object {
        ...
        const val DEFAULT_MASK_WIDTH = 0.90f
        const val DEFAULT_GRADIENT_CENTER_COLOR_WIDTH = 0.2f

        const val DEFAULT_ANGLE: Int = 0

        const val MIN_ANGLE_VALUE: Int = -45
        const val MAX_ANGLE_VALUE: Int = 45
        const val MIN_MASK_WIDTH_VALUE: Int = 0
        const val MAX_MASK_WIDTH_VALUE: Int = 1

        const val MIN_GRADIENT_CENTER_COLOR_WIDTH_VALUE: Int = 0
        const val MAX_GRADIENT_CENTER_COLOR_WIDTH_VALUE: Int = 1
        val DEFAULT_ANIMATOR = SkeletonDrawableAnimator(DEFAULT_ANIMATION_DURATION.toLong())

        const val COLOR_DISTRIBUTION_ALPHA_TRANSPARENT = 0f
        const val COLOR_DISTRIBUTION_ALPHA_MIDDLE = 0.5f
        const val COLOR_DISTRIBUTION_ALPHA_OPAQUE = 1f
        const val HALF = 2f
    }
